import {Component, OnInit, Input, TemplateRef, Output, EventEmitter, ViewEncapsulation, HostListener, Inject} from '@angular/core';
...
import {RowArgs, DataStateChangeEvent, GridDataResult} from '@progress/kendo-angular-grid';
